...
public class PhaseProgressStartEvent extends ProgressStartEvent {
    ...
    public PhaseProgressStartEvent(OperationIdentifier progressOperationId, @Nullable OperationIdentifier parentProgressOperationId, long timestamp, String category, String description, @Nullable String shortDescription, @Nullable String loggingHeader, String status, Object buildOperationId, @Nullable Object parentBuildOperationId, long children) {
